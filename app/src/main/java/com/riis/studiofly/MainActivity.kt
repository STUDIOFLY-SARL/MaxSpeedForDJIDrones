...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val mainMenuButtonToSettingsSpeed = findViewById<Button>(R.id.button_to_settings_speed)
        mainMenuButtonToSettingsSpeed.setOnClickListener {
            val intent = Intent(this, SettingsForSpeed::class.java)
